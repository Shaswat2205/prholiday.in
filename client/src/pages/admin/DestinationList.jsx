                    ...
                    <table className="w-full text-left text-gray-300">
                        ...
                        <tbody className="divide-y divide-gray-700">
                            {destinations.map(dest => (
                                <tr key={dest._id} className="hover:bg-gray-750">
                                    ...
                                    <td className="px-6 py-4 space-x-3">
                                        <Link to={`/admin/destinations/edit/${dest._id}`} className="text-blue-400 hover:text-blue-300">
                                            <FaEdit size={18} />
                                        </Link>
                                        <button onClick={() => handleDelete(dest._id)} className="text-red-400 hover:text-red-300">
                                            <FaTrash size={18} />
                                        </button>
                                        <Link to={`/destinations/${dest._id}`} target="_blank" className="text-gray-400 hover:text-gray-300">
                                            <FaEye size={18} />
                                        </Link>
                                    </td>
                                </tr>
